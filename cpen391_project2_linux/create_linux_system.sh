...
linux_src_git_checkout_commit="efb6672935894e19e30227b2fcc64546b70342ea"
...
linux_dtb_file="$(readlink -m "${linux_src_dir}/arch/arm/boot/dts/socfpga_cyclone5_CPEN391.dtb")" #socdk.dtb # socfpga_cyclone5_de0_sockit.dtb

rootfs_dir="${linux_dir}/rootfs"
rootfs_chroot_dir="$(readlink -m ${rootfs_dir}/ubuntu-core-rootfs)"
rootfs_lib_dir="$(readlink -m ${rootfs_dir}/ubuntu-core-rootfs)"
...
sdcard_partition_size_linux="4096M"
...
EOF
    ...
    # change working directory to linux and copy modules
    pushd "${linux_src_dir}"
    make modules_install INSTALL_MOD_PATH=$rootfs_lib_dir
    popd
